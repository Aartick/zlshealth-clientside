...
function page() {
    ...
    return (
        <div className='space-y-[30px]'>
            {/* Header + Image */}
            <div className='flex flex-col items-center text-center pb-5 space-y-3'>
                <p className="font-bold text-[40px] text-[#093C16] max-w-[658px]">
            ...
            <div className="flex flex-col items-center space-y-[30px] text-center">
                ...
                <div className="flex items-center gap-[66px]">
                    ...
                    <div className="flex flex-col items-center space-y-1.5">
                        <svg width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M8.5 24H19.1667" stroke="black" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M4.5 29.3333H28.5" stroke="black" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M19.1666 29.3334C21.6419 29.3334 24.0159 28.3501 25.7662 26.5997C27.5166 24.8494 28.4999 22.4754 28.4999 20.0001C28.4999 17.5247 27.5166 15.1508 25.7662 13.4004C24.0159 11.6501 21.6419 10.6667 19.1666 10.6667H17.8333" stroke="black" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M12.5 18.6667H15.1667" stroke="black" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M12.4999 16C11.7927 16 11.1144 15.719 10.6143 15.219C10.1142 14.7189 9.83325 14.0406 9.83325 13.3333V8H17.8333V13.3333C17.8333 14.0406 17.5523 14.7189 17.0522 15.219C16.5521 15.719 15.8738 16 15.1666 16H12.4999Z" stroke="black" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M16.5001 8.00008V4.00008C16.5001 3.64646 16.3596 3.30732 16.1096 3.05727C15.8595 2.80722 15.5204 2.66675 15.1667 2.66675H12.5001C12.1465 2.66675 11.8073 2.80722 11.5573 3.05727C11.3072 3.30732 11.1667 3.64646 11.1667 4.00008V8.00008" stroke="black" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    ...
                    <div className="flex flex-col items-center space-y-1.5">
                        <svg width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M19.1667 23.9999V7.99992C19.1667 7.29267 18.8858 6.6144 18.3857 6.1143C17.8856 5.6142 17.2073 5.33325 16.5001 5.33325H5.83341C5.12617 5.33325 4.44789 5.6142 3.9478 6.1143C3.4477 6.6144 3.16675 7.29267 3.16675 7.99992V22.6666C3.16675 23.0202 3.30722 23.3593 3.55727 23.6094C3.80732 23.8594 4.14646 23.9999 4.50008 23.9999H7.16675" stroke="black" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M20.5 24H12.5" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <path d="M23.1667 26.6666C24.6394 26.6666 25.8333 25.4727 25.8333 23.9999C25.8333 22.5272 24.6394 21.3333 23.1667 21.3333C21.6939 21.3333 20.5 22.5272 20.5 23.9999C20.5 25.4727 21.6939 26.6666 23.1667 26.6666Z" stroke="black" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M9.83341 26.6666C11.3062 26.6666 12.5001 25.4727 12.5001 23.9999C12.5001 22.5272 11.3062 21.3333 9.83341 21.3333C8.36066 21.3333 7.16675 22.5272 7.16675 23.9999C7.16675 25.4727 8.36066 26.6666 9.83341 26.6666Z" stroke="black" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                        <p className="font-semibold text-sm">
                            Fast Delivery
                        </p>
