                    ...
                    <div className="flex flex-col space-y-3">
                        {thumbnails.map((img, i) => (
                            <Image
                                ...
                                height={150}
                                alt={`Thumbnail ${i + 1}`}
                                className={`rounded-xs cursor-pointer transition-all duration-300 ${selectedImage === img ? "ring-2 ring-[#71BF45]" : ""
                                    }`}
                ...
                <div className="flex-1 p-3 md:p-6">
                    <div className="space-y-4 border-b-[3px] border-[#e3e3e3] px-2.5 pb-5">
                        ...
                        <div>
                            ...
                            <p className="text-[#848484]">{product?.about} - 30 Caplets</p>
                        </div>

                        {/* Product description */}
                        <p className="text-sm text-[#848484]">{product.shortDescription}</p>
                        ...
                        <ul className='space-y-5 text-xs'>
                            <li className='flex items-center space-x-2.5'>
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M12.6699 6V8M12.6699 8V10M12.6699 8H10.6699M12.6699 8H14.6699M8.66992 14H16.6699M9.66992 18H15.6699" stroke="#71BF45" stroke-width="1.5" stroke-linecap="round" />
                                </svg>
                                <div>
                                    <span className="text-[#093C16] font-semibold">Category:</span>{" "}Herbal Blood Sugar Support
                                </div>
                            </li>
                            <li className='flex items-center space-x-2.5'>
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div>
                                    <span className="text-[#093C16] font-semibold">Form:</span>{" "}1g Caplet
                                </div>
                            </li>
                            <li className='flex items-center space-x-2.5'>
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M9.66992 15H15.6699M12.6699 12V18" stroke="#71BF45" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                                <div>
                                    <span className="text-[#093C16] font-semibold">Pack size:</span>{" "} 30 Caplets
                                </div>
                            </li>
                            <li className='flex items-center space-x-2.5'>
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div>
                                    <span className="text-[#093C16] font-semibold">Applied for:</span>{" "}Blood sugar & lipid control, improved energy, insulin sensitivity
                                </div>
                            </li>
                            <li className='flex items-center space-x-2.5'>
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div>
                                    <span className="text-[#093C16] font-semibold">Suitable for:</span>{" "}Adults only
                                </div>
                            </li>
                            <li className='flex items-center space-x-2.5'>
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div>
                                    <span className="text-[#093C16] font-semibold">Safety:</span>{" "}No side effects, safe for long-term user
                                </div>
                            </li>
                        </ul>
                    </div>
