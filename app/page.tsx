      ...
      <section className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2 px-10 text-xs md:text-base">
        ...
        >
          <svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="52" height="52" rx="6" fill="#093C16" fillOpacity={activeBtn === "digestiveAndGutHealth" ? "1" : "0.04"} />
        ...
        >
          <svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="52" height="52" rx="6" fill="#093C16" fillOpacity={activeBtn === "respiratory" ? "1" : "0.04"} />
        ...
        >
          <svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="52" height="52" rx="6" fill="#093C16" fillOpacity={activeBtn === "painRelief" ? "1" : "0.04"} />
        ...
        >
          <svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="52" height="52" rx="6" fill="#093C16" fillOpacity={activeBtn === "mentalHealthRelief" ? "1" : "0.04"} />
        ...
        >
          <svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="52" height="52" rx="6" fill="#093C16" fillOpacity={activeBtn === "skinCareRoutine" ? "1" : "0.04"} />
