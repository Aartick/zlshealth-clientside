...
export default function Home() {
    ...
    const ctx = gsap.context(() => {
      ...
      const tl = gsap.timeline({
        scrollTrigger: {
          ...
          end: () => `+=${paras.length * 1000}`, // shorter on desktop for less lag
          scrub: true, // smooth scrubbing on desktop, instant on mobile
          pin: true, // pin this section while animating
          anticipatePin: 1, // Ensure proper spacing for pinned element
        }
      });
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const SCROLL_PIXELS_PER_STEP = 900; // shorter on desktop for less lag
