      ...
      <section className="container mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2 px-10 text-xs md:text-base">
        <button
          ...
          className={`
            ...
            ${activeBtn === "Digestive & Gut Health"
              ? "border-[#093C16]"
              : "border-[#e0e0e0]"}
        ...
        <button
          onClick={() => setActiveBtn("Pain Relief")}
          className={`
            flex items-center gap-[15px] 
            p-1.5 rounded-[8px] border 
            ${activeBtn === "Pain Relief"
              ? "border-[#093C16]"
              : "border-[#e0e0e0]"}
            transition-all duration-500
            ease-out cursor-pointer
        ...
        <button
          onClick={() => setActiveBtn("Mental Health Relief")}
          className={`
            flex items-center gap-[15px] 
            p-1.5 rounded-[8px] border 
            ${activeBtn === "Mental Health Relief"
              ? "border-[#093C16]"
              : "border-[#e0e0e0]"}
            transition-all duration-500
            ease-out cursor-pointer
        ...
        <button
          onClick={() => setActiveBtn("Skin Care Routine")}
          className={`
            flex items-center gap-[15px] 
            p-1.5 rounded-[8px] border 
            ${activeBtn === "Skin Care Routine"
              ? "border-[#093C16]"
              : "border-[#e0e0e0]"}
            transition-all duration-500
            ease-out cursor-pointer
        ...
        >
          <svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="52" height="52" rx="6" fill="#093C16" fillOpacity={activeBtn === "Skin Care Routine" ? "1" : "0.04"} />
