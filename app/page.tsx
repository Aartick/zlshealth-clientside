...
export default function Home() {
  ...
  const [activeBtn, setActiveBtn] = useState("digestiveAndGutHealth")
  ...
  return (
    <div className="bg-[#FBFFF9] space-y-10 pb-8">
      ...
      <section className="relative lg:hidden flex justify-between bg-[#f3f3f3] border-[0.5px] border-[#71BF45] rounded-[10px] mx-6 py-5 px-[10px] drop-shadow-[0px_4px_15.8px_rgba(132, 132, 132, 0.2)]">
      ...
      {/* PRODUCTS FILTERS */}
      <section className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2 px-10">
        <button
          onClick={() => setActiveBtn("digestiveAndGutHealth")}
          className={`
            flex items-center gap-[15px] 
            p-1.5 rounded-[8px] border 
            ${activeBtn === "digestiveAndGutHealth"
              ? "border-[#093C16]"
              : "border-[#e0e0e0]"}
        ...
        <button
          onClick={() => setActiveBtn("respiratory")}
          className={`
            flex items-center gap-[15px] 
            p-1.5 rounded-[8px] border 
            ${activeBtn === "respiratory"
              ? "border-[#093C16]"
              : "border-[#e0e0e0]"}
            transition-all duration-500
            ease-out cursor-pointer
        ...
        >
          <svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="52" height="52" rx="6" fill="#093C16" fill-opacity={activeBtn === "respiratory" ? "1" : "0.04"} />
        ...
        <button
          onClick={() => setActiveBtn("painRelief")}
          className={`
            flex items-center gap-[15px] 
            p-1.5 rounded-[8px] border 
            ${activeBtn === "painRelief"
              ? "border-[#093C16]"
              : "border-[#e0e0e0]"}
            transition-all duration-500
            ease-out cursor-pointer
        ...
        <button
          onClick={() => setActiveBtn("mentalHealthRelief")}
          className={`
            flex items-center gap-[15px] 
            p-1.5 rounded-[8px] border 
            ${activeBtn === "mentalHealthRelief"
              ? "border-[#093C16]"
              : "border-[#e0e0e0]"}
            transition-all duration-500
            ease-out cursor-pointer
        ...
        >
          ...
          <p>Mental Health Relief</p>
        </button>

        <button
          onClick={() => setActiveBtn("skinCareRoutine")}
          className={`
            flex items-center gap-[15px] 
            p-1.5 rounded-[8px] border 
            ${activeBtn === "skinCareRoutine"
              ? "border-[#093C16]"
              : "border-[#e0e0e0]"}
            transition-all duration-500
            ease-out cursor-pointer
        ...
        >
          <svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="52" height="52" rx="6" fill="#093C16" fill-opacity={activeBtn === "skinCareRoutine" ? "1" : "0.04"} />
      ...
      <section className="py-[30px] px-[30px] md:px-[60px] space-y-6">
        ...
        <div className="flex items-center flex-col md:flex-row gap-[50px]">
          ...
          <div className="flex-1 rounded-[40px] p-[30px] space-y-3 bg-gradient-to-b from-[#FBFFF9] to-[#79D347]">
