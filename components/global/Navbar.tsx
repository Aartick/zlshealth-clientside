...
function Navbar() {
    ...
    return (
        <div className="z-40 fixed w-full flex justify-between items-center sm:gap-[40px] py-[10px] sm:py-2 px-4 sm:px-10 drop-shadow-[0px_4px_15.8px_rgba(0,0,0,0.06)] bg-white">
            ...
            {/* Search */}
            <div className="hidden relative flex-1 sm:flex justify-between bg-[#f3f3f3] border-[0.5px] border-[#71BF45] rounded-[10px] py-5 px-[10px] drop-shadow-[0px_4px_15.8px_rgba(132, 132, 132, 0.2)]">
